...
![](https://github.com/zhangchengk/img/raw/master/数据库/字节序/1.png)

![](https://github.com/zhangchengk/img/raw/master/数据库/字节序/2.png)

MySQL通过JDBC读取到的是大端字节序`[1,3]`。

再查看binlog日志解析得到的`byte[]`得到的是小端字节序`[3,1]`

![](https://github.com/zhangchengk/img/raw/master/数据库/字节序/5.png)
...
![](https://github.com/zhangchengk/img/raw/master/数据库/字节序/3.png)

![](https://github.com/zhangchengk/img/raw/master/数据库/字节序/4.png)

Pg(Gp)通过JDBC读取到的是大端字节序`[1,3]`。

通过插槽CDC获得是小端字节序`[3,1]`

![](https://github.com/zhangchengk/img/raw/master/数据库/字节序/6.png)
