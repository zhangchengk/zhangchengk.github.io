...
![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/设计模式就该这样学/设计模式常用的UML图/epub_33114758_13.jpeg) 
...
![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/设计模式就该这样学/设计模式常用的UML图/epub_33114758_14.jpeg) 
...
![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/设计模式就该这样学/设计模式常用的UML图/epub_33114758_16.jpeg) 
...
![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/设计模式就该这样学/设计模式常用的UML图/epub_33114758_18.jpeg) 
...
![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/设计模式就该这样学/设计模式常用的UML图/epub_33114758_20.jpeg) 
...
![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/设计模式就该这样学/设计模式常用的UML图/epub_33114758_22.jpeg) 

在多重性关联关系中，可以直接在关联直线上增加一个数字，表示与之对应的另一个类的对象的个数，具体含义如下表所示。

![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/设计模式就该这样学/设计模式常用的UML图/epub_33114758_23.jpeg) 
...
![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/设计模式就该这样学/设计模式常用的UML图/epub_33114758_25.jpeg) 
...
![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/设计模式就该这样学/设计模式常用的UML图/epub_33114758_27.jpeg) 
...
![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/设计模式就该这样学/设计模式常用的UML图/epub_33114758_28.jpeg) 
...
![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/设计模式就该这样学/设计模式常用的UML图/epub_33114758_29.jpeg) 
...
![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/设计模式就该这样学/设计模式常用的UML图/epub_33114758_30.jpeg) 

### 2.2.3　时序图组合片段

组合片段（Combined Fragments）用来解决交互执行的条件和方式，它允许在时序图中直接表示逻辑组件，用于通过指定条件或子进程的应用区域，为任何生命线的任何部分定义特殊条件和子进程。组合片段共有13种，名称及含义如下表所示。

![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/设计模式就该这样学/设计模式常用的UML图/epub_33114758_31.jpeg) 
...
![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/设计模式就该这样学/设计模式常用的UML图/epub_33114758_32.jpeg) 

**2.选项（Opt）**

包含一个可能发生或不发生的序列，如下图所示。

![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/设计模式就该这样学/设计模式常用的UML图/epub_33114758_33.jpeg) 

**3.循环（Loop）**

片段重复一定次数，可以在临界中指示片段重复的条件，如下图所示。

![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/设计模式就该这样学/设计模式常用的UML图/epub_33114758_34.jpeg) 

**4.并行（Par）**

并行处理，片段中的事件可以并行交错，Par相当于多线程，如下图所示。

![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/设计模式就该这样学/设计模式常用的UML图/epub_33114758_35.jpeg) 
...
![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/设计模式就该这样学/设计模式常用的UML图/epub_33114758_37.jpeg) 
