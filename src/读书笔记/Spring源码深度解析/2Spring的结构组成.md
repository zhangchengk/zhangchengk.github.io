...
![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/Spring源码深度解析/2Spring的结构组成/1.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/Spring源码深度解析/2Spring的结构组成/2.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/Spring源码深度解析/2Spring的结构组成/3.png)

## beans 包的层级结构及核心类介绍

上面的测试项目我们只引入了`spring-beans`(当然spring-core是必需的)

![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/Spring源码深度解析/2Spring的结构组成/4.png)

我们先看看整个beans工程的源码结构

![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/Spring源码深度解析/2Spring的结构组成/5.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/Spring源码深度解析/2Spring的结构组成/6.png)

![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/Spring源码深度解析/2Spring的结构组成/7.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/Spring源码深度解析/2Spring的结构组成/8.png)
