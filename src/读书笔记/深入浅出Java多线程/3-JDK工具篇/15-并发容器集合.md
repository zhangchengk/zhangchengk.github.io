...
![](https://gitee.com/zhangchengk/img/raw/master/img//Users/zhangcheng/vscodeProjects/image/深入浅出Java多线程/15/1.png)

其中，阻塞队列（BlockingQueue）在[阻塞队列](./13-阻塞队列.md)有介绍，CopyOnWrite容器（CopyOnWritexxx）在[CopyOnWrite](./16-CopyOnWrite.md)有介绍，这里不做过多介绍。
...
![](https://gitee.com/zhangchengk/img/raw/master/img//Users/zhangcheng/vscodeProjects/image/深入浅出Java多线程/15/2.png)
