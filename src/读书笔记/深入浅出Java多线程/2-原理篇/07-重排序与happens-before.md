...
![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/深入浅出Java多线程/07-重排序与happens-before/正确同步.png)

操作的执行整体上有序，并且两个线程都只能看到这个执行顺序。

假设**没有使用同步**，那么在**顺序一致性模型**中的执行效果如下所示：

![](https://gitee.com/zhangchengk/image/raw/master/读书笔记/深入浅出Java多线程/07-重排序与happens-before/没有正确同步.png)
