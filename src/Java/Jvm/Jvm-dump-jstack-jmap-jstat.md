...
![](https://gitee.com/zhangchengk/img/raw/master/Jvm_dump_jstack_jmap_jstat介绍与使用/1.png)
![](https://gitee.com/zhangchengk/img/raw/master/Jvm_dump_jstack_jmap_jstat介绍与使用/2.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/Jvm_dump_jstack_jmap_jstat介绍与使用/3.png)

使用top查看目前正在运行的进程使用系统资源情况。

![](https://gitee.com/zhangchengk/img/raw/master/Jvm_dump_jstack_jmap_jstat介绍与使用/4.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/Jvm_dump_jstack_jmap_jstat介绍与使用/5.png)
