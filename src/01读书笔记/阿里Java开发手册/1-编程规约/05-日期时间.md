...
4. <font color=red>【强制】</font>不允许在程序任何地方中使用：
- 1）java.sql.Date 
- 2）java.sql.Time 
...
6. <font color=green>【推荐】</font>避免公历闰年 2 月问题。闰年的 2 月份有 29 天，一年后的那一天不可能是 2 月 29日。

7. <font color=green>【推荐】</font>使用枚举值来指代月份。如果使用数字，注意 Date，Calendar 等日期相关类的月份month 取值在 0-11 之间。
:::warning 说明
