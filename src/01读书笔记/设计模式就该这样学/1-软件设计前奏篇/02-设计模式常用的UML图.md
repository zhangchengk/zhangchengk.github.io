...
![](../img/2/epub_33114758_22.jpeg) 

在多重性关联关系中，可以直接在关联直线上增加一个数字，表示与之对应的另一个类的对象的个数，具体含义如下表所示。

![](../img/2/epub_33114758_23.jpeg) 
...
![](../img/2/epub_33114758_32.jpeg) 

**2.选项（Opt）**

包含一个可能发生或不发生的序列，如下图所示。

![](../img/2/epub_33114758_33.jpeg) 

**3.循环（Loop）**

片段重复一定次数，可以在临界中指示片段重复的条件，如下图所示。

![](../img/2/epub_33114758_34.jpeg) 

**4.并行（Par）**

并行处理，片段中的事件可以并行交错，Par相当于多线程，如下图所示。

![](../img/2/epub_33114758_35.jpeg) 
