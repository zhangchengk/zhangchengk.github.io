...
![](https://github.com/zhangchengk/img/raw/master/nifi/1/004/6.png)

2. 自定义一个独立的子Moudle，子Moudle里面有两个子项目:`processors`和`processor-nar`子项目。以NIFI源码的amqp为例
![](https://github.com/zhangchengk/img/raw/master/nifi/1/004/7.png)

   `processors`里面写MyProcessor.jav，打jar包，
![](https://github.com/zhangchengk/img/raw/master/nifi/1/004/8.png)

   把`processors`的jar包依赖放到`processor-nar`项目里，打nar包，
![](https://github.com/zhangchengk/img/raw/master/nifi/1/004/9.png)

   最后把这个nar包依赖放到`nifi-assembly`的pom.xml里即可
![](https://github.com/zhangchengk/img/raw/master/nifi/1/004/10.png)
...
![](https://github.com/zhangchengk/img/raw/master/nifi/1/004/11.png)
...
![](https://github.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI开发/004自定义Processor/1.png)
```java
...
![](https://github.com/zhangchengk/img/raw/master/nifi/1/004/12.png)
