...
详情请看 gitee [https://gitee.com/zhangchengk/custom-nar-bundles](https://gitee.com/zhangchengk/custom-nar-bundles)（这是一个NIFI Maven子项目，用于自定义开发，减少对源码结构的侵入，方便NIFI升级 ）
