...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI开发/003-Processor组件类的一些方法/1.png)
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI开发/003-Processor组件类的一些方法/2.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI开发/003-Processor组件类的一些方法/3.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI开发/003-Processor组件类的一些方法/4.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI开发/003-Processor组件类的一些方法/5.png)
返回的json
```json
{
    "propertyDescriptor": {
