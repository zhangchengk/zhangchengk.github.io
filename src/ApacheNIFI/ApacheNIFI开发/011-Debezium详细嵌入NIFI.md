...
![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/1.png)
...
![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/2.png)
...
![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/3.png)

## 3.7 异常捕获

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/4.png)
...
![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/5.png)

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/6.png)
...
![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/7.png)

## 4.1 OffsetBackingStore

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/8.png)

## 4.2 SourceConnector

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/9.png)

## 4.3 SourceTask

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/10.png)

SourceTask.start是抽象方法,由BaseSourceTask实现

## 4.4 BaseSourceTask.start()

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/11.png)

start抽象方法，由各个xxxConnectorTask实现。

### 4.4.1 OracleConnectorTask.start为例

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/12.png)
...
![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/13.png)

## 4.5 ChangeEventSourceCoordinator.start

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/14.png)

## 4.6 SnapshotChangeEventSource

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/15.png)

### 4.6.1AbstractSnapshotChangeEventSource.execute

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/16.png)

### 4.6.2 RelationalSnapshotChangeEventSource.doExecute

重点要看两处，第一处锁表，第二处全量采集实现

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/17.png)

#### 4.6.2.1 锁表

AbstractSnapshotChangeEventSource.execute中会先判断是否skip Snapshot，否，则继续执行。

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/18.png)

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/19.png)

判断是否skip Snapshot,通用是既不schema，也不data；MongoDB特例，不data就skip。

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/20.png)

先假设skip为false，对于关系型数据库来说(MongoDB后面讨论)，会锁所有采集schema的表，条件是snapshottingTask.snapshotSchema()是true，那么我们解决锁表就是让这个返回为false

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/21.png)

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/22.png)
...
![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/23.png)

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/24.png)
...
![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/26.png)

##### 4.6.2.1.3 PostgreSql
 
若要使得pg 不锁表，snapshotter.shouldSnapshot()一定要返回false，使用NeverSnapshotter

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/27.png)

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/28.png)

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/29.png)

##### 4.6.2.1.4 SqlServer

若要使得SqlServer 不锁表，同Oracle一样，我们一定一定使其任何时候都有previousOffset！！！。

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/30.png)

##### 4.6.2.1.5 MongoDB

首先没有所谓锁表逻辑，但在实现MongoDB的Snapshot底层会去阻塞主节点！

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/31.png)
...
![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/32.png)
...
![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/33.png)

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/34.png)
...
![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/35.png)

### 4.7.1  LogMinerStreamingChangeEventSource.execute为例

processor.processResult(rs);

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/36.png)

TransactionalBuffer

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/37.png)

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/38.png)

### 4.7.2 EventDispatcher

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/39.png)

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/40.png)

### 4.7.3 ChangeRecordEmitter

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/41.png)

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/42.png)

### 4.7.4 总结

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/43.png)
...
![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/44.png)

# 五、 嵌入NIFI实现

以使用JSON为例。

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/45.png)
...
![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/46.png)

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/47.png)

### 5.1.2 初始化

#### 5.1.2.1 设置Debezium配置

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/48.png)

#### 5.1.2.2 使用自定义的Offset存储实现

这里顺便看一下StateMapOffsetBackingStore

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/49.png)

#### 5.1.2.3 初始化JSON转换器

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/50.png)

#### 5.1.2.4 初始化offset

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/51.png)

#### 5.1.2.5 初始化Debezium引擎

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/52.png)

### 5.1.3 调度执行

#### 5.1.3.1 自定义全量Snapshot

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/53.png)

#### 5.1.3.2 Debezium event → NIFI FlowFile

![](https://github.com/zhangchengk/img/raw/master/nifi/1/011/54.png)