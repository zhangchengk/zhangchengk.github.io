...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/014-ContentRepositoryArchiving理解/1.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/014-ContentRepositoryArchiving理解/2.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/014-ContentRepositoryArchiving理解/3.png)

在这里可以看到我们有一个包含大大小小内容的单一Content Claim。总体大小已超过10 MB，因为NiFi在开始流式传输该最终内容时声称该大小仍低于10 MB。

范例2：

![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/014-ContentRepositoryArchiving理解/4.png)

在这里，我们可以看到我们有一个仅包含一个内容的内容声明。这是因为一旦将内容写入此声明，声明就超出了配置的最大可附加大小。如果您的数据流只处理10 MB以上的文件，则所有内容声明将仅包含一件内容。

范例3：

![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/014-ContentRepositoryArchiving理解/5.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/014-ContentRepositoryArchiving理解/6.png)
