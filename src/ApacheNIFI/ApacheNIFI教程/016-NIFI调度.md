...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/016-NIFI调度/1.png)

![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/016-NIFI调度/2.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/016-NIFI调度/3.png)

我们分别来看一下这3个流文件的`Time`属性

![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/016-NIFI调度/4.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/016-NIFI调度/5.png)

然后我们要明确一点，Processor右上角的那个数字的含义是`Active Tasks`

![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/016-NIFI调度/6.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/016-NIFI调度/7.png)

作为对比，我们发送一个流文件，就能观察到日志输出：

![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/016-NIFI调度/8.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/016-NIFI调度/9.png)

![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/016-NIFI调度/10.png)
...
在[理解maxThread设置](./理解maxThread设置.md)一文中介绍了`最大计时器线程计数(Max Timer Driven Thread Count)`，那么问题是：**在上面所述，我们检测到组件没有工作要做，在检测的时候它占用了线程池里的线程嘛？** 
...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/016-NIFI调度/11.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/016-NIFI调度/13.png)

使用PostMan做Get请求结果如图：

![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/016-NIFI调度/14.png)

如果我们不按第四步修改代码，日志会很快很快的打印`当前组件没有工作可以做，进入当前处理逻辑，防止处理太快我们查不到正在运行的线程，我们睡眠2秒`,并且我们通过Rest接口查询的结果通常就是0

![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/016-NIFI调度/12.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/016-NIFI调度/15.png)

![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/016-NIFI调度/16.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/016-NIFI调度/19.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/016-NIFI调度/17.png)

![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/016-NIFI调度/18.png)
