...
![](https://github.com/zhangchengk/img/raw/master/nifi/021//1.png)

点击登录或者新注册一个用户

![](https://github.com/zhangchengk/img/raw/master/nifi/021//2.png)

![](https://github.com/zhangchengk/img/raw/master/nifi/021//3.png)

进入JIRA后,新建一个issue(新功能或者是bug描述等等)

![](https://github.com/zhangchengk/img/raw/master/nifi/021//4.png)

然后再填写详细的描述信息

![](https://github.com/zhangchengk/img/raw/master/nifi/021//5.png)

以我之前提的新增功能点的NIFI-7403为例(这个已经被合并到master分支,所以状态显示跟新建的会不一样)

![](https://github.com/zhangchengk/img/raw/master/nifi/021//6.png)

## Fork源码

在GitHub上找到Apache NIFI的 项目,然后fork到自己的GitHub

![](https://github.com/zhangchengk/img/raw/master/nifi/021//7.png)

把你自己GitHub账号里fork后的代码拉到你的开发环境,这里别忘了应该配置git的upstream,以便你可以同步Apache NIFI的最新代码

![](https://github.com/zhangchengk/img/raw/master/nifi/021//8.png)
...
![](https://github.com/zhangchengk/img/raw/master/nifi/021//9.png)
...
![](https://github.com/zhangchengk/img/raw/master/nifi/021//10.png)
...
![](https://github.com/zhangchengk/img/raw/master/nifi/021//12.png)

提交PR后会自动编译检测(期间会运行单元测试),一般上需要检测成功后才会被Review

![](https://github.com/zhangchengk/img/raw/master/nifi/021//11.png)
...
![](https://github.com/zhangchengk/img/raw/master/nifi/021//13.png)
