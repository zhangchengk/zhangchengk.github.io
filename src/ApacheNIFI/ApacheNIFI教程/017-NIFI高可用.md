...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/017-NIFI高可用/1.png)

集群启动成功

![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/017-NIFI高可用/2.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/017-NIFI高可用/4.png)

配置`connection`为load balance(分发数据到各个节点，否则所有的数据其实都是在主节点运行处理)

![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/017-NIFI高可用/3.png)

### 探索集群节点失联后流文件的分布

由上面的流程截图状态我们看到当前流程里集群有3个节点，一共有111个流文件，现在我们手动停止一个NIFI节点，模拟因未知原因节点失联

![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/017-NIFI高可用/5.png)

然后等待集群重新投票选举，选举完成后我们打开NIFI集群界面

![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/017-NIFI高可用/6.png)

这时我们看到NIFI集群中只剩下了74个流文件了，缺失的那37个流文件还在失联的节点上。同时也可以看到，现在集群是不允许你修改流程的配置的，直到失联节点重新连回集群或者系统管理员卸载失联节点。

![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/017-NIFI高可用/7.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/017-NIFI高可用/8.png)

启动后，我们立马停止其中一个节点来模拟故障(这里我直接kill掉了一个节点)

![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/017-NIFI高可用/9.png)

等到集群完成重新选举打开集群界面，观察失联节点后的集群：

![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/017-NIFI高可用/10.png)
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/017-NIFI高可用/11.png)
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/017-NIFI高可用/12.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/017-NIFI高可用/13.png)

如下图，这是一个与集群失联的节点，我们还可以访问到它的用户界面

![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/017-NIFI高可用/14.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/017-NIFI高可用/15.png)
...
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/017-NIFI高可用/16.png)

重复上面模拟节点失联，查看集群`GenerateFlow`的状态

![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/017-NIFI高可用/17.png)
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/017-NIFI高可用/18.png)

可以看到，设置为主节点运行的`GenerateFlow`仍在运行生成流文件。

而失联节点在观察了几分钟后，`GenerateFlow`都没有生成流文件。
![](https://gitee.com/zhangchengk/image/raw/master/ApacheNIFI/ApacheNIFI教程/017-NIFI高可用/19.png)
