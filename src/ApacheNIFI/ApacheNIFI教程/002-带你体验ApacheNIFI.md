...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/2.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/22.png)

最终我一共向`source`表里写了253001条数据。

![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/23.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/1.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/3.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/4.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/24.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/5.png)

点击Apply后，回到设计页面，我们发现组件左上角是一个感叹号，感叹号你可以理解为这个组件还没有满足运行的条件，把鼠标停留在感叹号上会有提示信息

![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/6.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/7.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/8.png)

点击对话框的`PROPERTIES`页签，按如下图所示配置MySQL数据库的连接信息。

![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/9.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/10.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/11.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/12.png)

指向的过程中会弹出`Create Connection`的配置页面，在里面的`For Relationships`勾选`success`(后期我们可以右键点击`Connection`进入配置页面)

![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/13.png)

点击`ADD`后，再次回到设计页面

![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/14.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/15.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/16.png)

![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/17.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/18.png)

![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/19.png)

![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/20.png)

![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/21.png)

**8.运行整个数据处理流程**

右键点击每个组件选择start或者点击空白出选择start

![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/25.png)

可以看到已经有数据在流动被处理了。

写入数据总是比较慢的，这个时候我们可以适当的停止`PutDatabaseRecord`组件修改配置提高它的并发任务数(注意只有stop这个组件，才可以对它进行配置)

![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/26.png)

当我们再次运行`PutDatabaseRecord`组件，在设计页面会发现流程报错了(这并不是意外，这是我设计好展示给你们看的效果)

![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/27.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/28.png)

**10.持续运行**

那么这就完了嘛？不，我们这个流程不是一个一次性任务，它是持续的。如下图所示

![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/29.png)

此时我们向`source`添加一条数据，它是第`253002`条

![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/30.png)

添加完后观察我们正在运行的流程，发现原本组件上那些`In`、`Out`已经为0的状态现在变成了1，说明刚才有数据流过了。

![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/31.png)

然后我们去查看`target`表，发现第`253002`条数据已经被同步过来了。

![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/32.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/33.png)

如下图，我们可以看到`Compontent State`这个对话框里记录了`increase`的值。

![](https://gitee.com/zhangchengk/img/raw/master/nifi/002/34.png)
