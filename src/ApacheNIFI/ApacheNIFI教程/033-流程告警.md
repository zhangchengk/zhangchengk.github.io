...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/033/15.jpg)

## NiFi Bulletin Board

组件`Bulletin Level`可设置对应的日志级别(比如下面截图用到的LogMessage设置成warn)，组件输出的相应级别的日志会相应发送到`Bulletin Board`。

![](https://gitee.com/zhangchengk/img/raw/master/nifi/033/1.png)

![](https://gitee.com/zhangchengk/img/raw/master/nifi/033/2.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/033/3.png)

然后在当前的NIFI节点配置一个接收数据的`Input Port`

![](https://gitee.com/zhangchengk/img/raw/master/nifi/033/4.png)

将`SiteToSiteBulletinReportingTask`启动，将命名为`warn`的`Input Port`启动，然后人为造一个错误消息

![](https://gitee.com/zhangchengk/img/raw/master/nifi/033/5.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/033/9.png)

![](https://gitee.com/zhangchengk/img/raw/master/nifi/033/10.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/033/13.jpg)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/033/12.png)
...
![](https://gitee.com/zhangchengk/img/raw/master/nifi/033/14.jpg)
