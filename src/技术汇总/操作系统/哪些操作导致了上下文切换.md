...
![](https://gitee.com/zhangchengk/img/raw/master/img/操作系统/上下文切换.jpg)
...
![](https://gitee.com/zhangchengk/img/raw/master/img/操作系统/上下文切换3.jpg)

如果是监视某个应用的上下文切换，就可以使用 pidstat 命令监控指定进程的 Context Switch 上下文切换。

![](https://gitee.com/zhangchengk/img/raw/master/img/操作系统/上下文切换4.jpg)
