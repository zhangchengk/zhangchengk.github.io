...
[原文传送门](https://www.cnkirito.moe/servlet-explore/)
...
* T createServlet(Class`<t>` clazz)
* ServletRegistration getServletRegistration(String servletName)
* Map<String,? extends ServletRegistration> getServletRegistrations()

其中前三个方法的作用是相同的，只是参数类型不同而已；通过 createServlet()方法创建的 Servlet，通常需要做一些自定义的配置，然后使用 addServlet() 方法来将其动态注册为一个可以用于服务的 Servlet。两个 getServletRegistration() 方法主要用于动态为 Servlet 增加映射信息，这等价于在 web.xml 中使用 
`<servlet-mapping>` 标签为存在的 Servlet 增加映射信息。
...
[![WebApplicationInitializer](https://kirito.iocoder.cn/WebApplicationInitializer.png)](https://kirito.iocoder.cn/WebApplicationInitializer.png "WebApplicationInitializer")WebApplicationInitializer
...
[![SpringServletContainerInitializer](https://kirito.iocoder.cn/F835D518-A725-40D9-84BA-6AC014DAE5A7.png)](https://kirito.iocoder.cn/F835D518-A725-40D9-84BA-6AC014DAE5A7.png "SpringServletContainerInitializer")SpringServletContainerInitializer

注意，上述这一切特性从 spring 3 就已经存在了，而如今 spring 5 已经伴随 springboot 2.0 一起发行了。

### [](https://www.cnkirito.moe/servlet-explore/#SpringBoot-%E5%A6%82%E4%BD%95%E5%8A%A0%E8%BD%BD-Servlet%EF%BC%9F "SpringBoot 如何加载 Servlet？")SpringBoot 如何加载 Servlet？
...
#### [](https://www.cnkirito.moe/servlet-explore/#%E6%B3%A8%E5%86%8C%E6%96%B9%E5%BC%8F%E4%B8%80%EF%BC%9Aservlet3-0-%E6%B3%A8%E8%A7%A3-ServletComponentScan "注册方式一：servlet3.0 注解 +@ServletComponentScan")注册方式一：servlet3.0 注解 +@ServletComponentScan
...
#### [](https://www.cnkirito.moe/servlet-explore/#%E6%B3%A8%E5%86%8C%E6%96%B9%E5%BC%8F%E4%BA%8C%EF%BC%9ARegistrationBean "注册方式二：RegistrationBean")注册方式二：RegistrationBean
...
[![RegistrationBean](https://kirito.iocoder.cn/RegistrationBean.png)](https://kirito.iocoder.cn/RegistrationBean.png "RegistrationBean")RegistrationBean
...
### [](https://www.cnkirito.moe/servlet-explore/#SpringBoot-%E4%B8%AD-servlet-%E5%8A%A0%E8%BD%BD%E6%B5%81%E7%A8%8B%E7%9A%84%E6%BA%90%E7%A0%81%E5%88%86%E6%9E%90 "SpringBoot 中 servlet 加载流程的源码分析")SpringBoot 中 servlet 加载流程的源码分析
...
#### [](https://www.cnkirito.moe/servlet-explore/#Initializer-%E8%A2%AB%E6%9B%BF%E6%8D%A2%E4%B8%BA-TomcatStarter "Initializer 被替换为 TomcatStarter")Initializer 被替换为 TomcatStarter
...
[![TomcatStarter](https://kirito.iocoder.cn/TomcatStarter.png)](https://kirito.iocoder.cn/TomcatStarter.png "TomcatStarter")TomcatStarter
...
#### [](https://www.cnkirito.moe/servlet-explore/#TomcatStarter-%E4%B8%AD%E7%9A%84-ServletContextInitializer-%E6%98%AF%E5%85%B3%E9%94%AE "TomcatStarter 中的 ServletContextInitializer 是关键")TomcatStarter 中的 ServletContextInitializer 是关键
...
[![initializers](https://kirito.iocoder.cn/35560726-DD9D-478A-BFCA-12ACF4DB497D.png)](https://kirito.iocoder.cn/35560726-DD9D-478A-BFCA-12ACF4DB497D.png "initializers")initializers
...
#### [](https://www.cnkirito.moe/servlet-explore/#EmbeddedWebApplicationContext-%E4%B8%AD%E7%9A%84-6-%E5%B1%82%E8%BF%AD%E4%BB%A3%E5%8A%A0%E8%BD%BD "EmbeddedWebApplicationContext 中的 6 层迭代加载")EmbeddedWebApplicationContext 中的 6 层迭代加载
...
### [](https://www.cnkirito.moe/servlet-explore/#EmbeddedWebApplicationContext-%E5%8A%A0%E8%BD%BD%E6%B5%81%E7%A8%8B%E6%80%BB%E7%BB%93 "EmbeddedWebApplicationContext 加载流程总结")EmbeddedWebApplicationContext 加载流程总结
...
[![getServletContextInitializerBeans](https://kirito.iocoder.cn/8FFCA673-DB72-4C0A-BDE9-58CB4B80C484.png)](https://kirito.iocoder.cn/8FFCA673-DB72-4C0A-BDE9-58CB4B80C484.png "getServletContextInitializerBeans")getServletContextInitializerBeans

### [](https://www.cnkirito.moe/servlet-explore/#%E7%AC%AC%E4%B8%89%E7%A7%8D%E6%B3%A8%E5%86%8C-Servlet-%E7%9A%84%E6%96%B9%E5%BC%8F "第三种注册 Servlet 的方式")第三种注册 Servlet 的方式
...
### [](https://www.cnkirito.moe/servlet-explore/#%E5%8A%A0%E8%BD%BD%E6%B5%81%E7%A8%8B%E6%8B%BE%E9%81%97 "加载流程拾遗")加载流程拾遗
...
### [](https://www.cnkirito.moe/servlet-explore/#%E6%80%BB%E7%BB%93 "总结")总结
...
### [](https://www.cnkirito.moe/servlet-explore/#%E6%8E%A8%E8%8D%90%E9%98%85%E8%AF%BB "推荐阅读")推荐阅读

JAVA 拾遗 – 关于 SPI 机制 https://www.cnkirito.moe/spi/

**欢迎关注我的微信公众号：「Kirito 的技术分享」，关于文章的任何疑问都会得到回复，带来更多 Java 相关的技术分享。**

[![关注微信公众号](https://kirito.iocoder.cn/qrcode_for_gh_c06057be7960_258%20%281%29.jpg)](https://kirito.iocoder.cn/qrcode_for_gh_c06057be7960_258%20%281%29.jpg "关注微信公众号")今天我们来放松下心情，不聊分布式，云原生，来聊一聊初学者接触的最多的 java web 基础。几乎所有人都是从 servlet，jsp，filter 开始编写自己的第一个 hello world 工程。那时，还离不开 web.xml 的配置，在 xml 文件中编写繁琐的 servlet 和 filter 的配置。随着 spring 的普及，配置逐渐演变成了两种方式—java configuration 和 xml 配置共存。现如今，springboot 的普及，java configuration 成了主流，xml 配置似乎已经“灭绝”了。不知道你有没有好奇过，这中间都发生了哪些改变，web.xml 中的配置项又是被什么替代项取代了？  
[![servlet](https://kirito.iocoder.cn/servlet.png)](https://kirito.iocoder.cn/servlet.png "servlet")servlet

### [](https://www.cnkirito.moe/servlet-explore/#servlet3-0-%E4%BB%A5%E5%89%8D%E7%9A%84%E6%97%B6%E4%BB%A3 "servlet3.0 以前的时代")servlet3.0 以前的时代
...
### [](https://www.cnkirito.moe/servlet-explore/#servlet3-0-%E6%96%B0%E7%89%B9%E6%80%A7 "servlet3.0 新特性")servlet3.0 新特性

[![servlet_3.0](https://kirito.iocoder.cn/servlet_3.0.jpg)](https://kirito.iocoder.cn/servlet_3.0.jpg "servlet_3.0")servlet_3.0
...
* ServletRegistration.Dynamic addServlet(String servletName, Servlet servlet)
* ServletRegistration.Dynamic addServlet(String servletName, String className)
* <t extends="" servlet=""> T createServlet(Class<t> clazz)</t></t>
* ServletRegistration getServletRegistration(String servletName)
* Map<String,? extends ServletRegistration> getServletRegistrations()

其中前三个方法的作用是相同的，只是参数类型不同而已；通过 createServlet()方法创建的 Servlet，通常需要做一些自定义的配置，然后使用 addServlet() 方法来将其动态注册为一个可以用于服务的 Servlet。两个 getServletRegistration() 方法主要用于动态为 Servlet 增加映射信息，这等价于在 web.xml 中使用 
<servlet-mapping> 标签为存在的 Servlet 增加映射信息。</servlet-mapping>
...
### [](https://www.cnkirito.moe/servlet-explore/#Spring-%E6%98%AF%E5%A6%82%E4%BD%95%E6%94%AF%E6%8C%81-servlet3-0-%E7%9A%84%EF%BC%9F "Spring 是如何支持 servlet3.0 的？")Spring 是如何支持 servlet3.0 的？
...
[![关注微信公众号](https://kirito.iocoder.cn/qrcode_for_gh_c06057be7960_258%20%281%29.jpg)](https://kirito.iocoder.cn/qrcode_for_gh_c06057be7960_258%20%281%29.jpg "关注微信公众号")